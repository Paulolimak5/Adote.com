...
<?php
	echo "<div class='inicio'><a>Bem vindo(a) ADM, ".$_SESSION['usuarioNome'] ."</a></div>";
?>
<a href="sair/" id="btn_sair" class="btn btn-primary">Sair</a>
                    ...
                    <div class="col-sm-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Cadastro de animais da página adote</p>
                                <a href="cadastro_animais/" class="btn btn-info">Cadastrar</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Editar animais</h5>
                                <p class="card-text">Edição de animais da página adote</p>
                                <a href="consulta_animal/" class="btn btn-warning">Editar</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Deletar animais</h5>
                                <p class="card-text">Deletar animais da página adote</p>
                                <a href="deleta_animais/" class="btn btn-danger">Deletar</a>
                            </div>
                        </div>
                    </div>
                </div>
