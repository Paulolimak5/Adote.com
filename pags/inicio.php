...
<?php
	echo "<div class='inicio'><a>Bem vindo(a), ".$_SESSION['usuarioNome'] ."</a></div>";
?>
...
<div class="row">
  <div class="col-sm-3">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Editar dados da sua conta</h5>
        <p class="card-text">Edição de informações da sua conta, matenha os dados sempre atualizados.</p>
        <a href="editar/" class="btn btn-info">Editar Perfil</a>
      </div>
    </div>
  </div>
  <div class="col-sm-3">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">Verifique a sua ficha de adoções</p>
        <a  class="btn btn-primary">Adoções</a>
      </div>
    </div>
  </div>
</div>
