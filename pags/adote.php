...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div class="adote_titulo">Adote nossos animais e compartilhe sua felicidade!</div>
        <div class="adote_card">
<?php
        ...
        echo "
            <div class='card' style='width: 18rem;'>
                <img class='card-img-top' src='assets/img/".$row['img']."' alt='Card image cap'>
                <div class='card-body'>
                    <h6 class='card-title'>Nome: " .$row['nome']. "</h6>
                    <h6 class='card-title'>Idade: " .$row['idade']. " Anos</h6>
                    <h6 class='card-title'>Peso: " .$row['peso']. "Kg</h6>
                    <h6 class='card-title'>Tipo: " .$row['tipo']. "</h6>
                    <h6 class='card-title'>Identificador: " .$row['id']. "</h6>
