...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div id="alterar" class="col-sm-6 offset-md-3">
            <div class="content">
                <form method="POST">
                    <h4>Insira a sua nova senha:</h4>
              
                    <label>Digite sua senha</labe>
                    <input type="password" name="senha" placeholder="Insira a nova senha..." class="form-control">
